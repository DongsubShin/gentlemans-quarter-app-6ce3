...
import { useLiveQueue, useServices } from '../hooks/useBookingData';
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services?.map((service) => (
              <div key={service.id} className="group bg-white border border-slate-100 p-8 rounded-2xl hover:shadow-2xl hover:-translate-y-1 transition-all">
